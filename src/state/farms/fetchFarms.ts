...
const fetchFarms = async () => {
  const data = await Promise.all(
    farmsConfig.map(async (farmConfig) => {
      ...
      const [info, totalAllocPoint, poolInfo, BengalsPerBlock] = await multicall(masterchefABI, [
        {
      ...
      return {
        ...
        BengalsPerBlock: new BigNumber(BengalsPerBlock).toNumber(),
