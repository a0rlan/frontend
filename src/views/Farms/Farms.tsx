...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  const farmsList = useCallback(
    (farmsToDisplay): FarmWithStakedValue[] => {
      ...
      let farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        //   return farm
        // }
        const cakeRewardPerBlock = new BigNumber(farm.BengalsPerBlock || 1)
  ...
  return (
    <>
      <Header>
        <Heading as="h1" size="xxl" color="Bengals" mb="24px">
          {tokenMode
            ? TranslateString(10002, 'Stake tokens to earn Bengals')
            : TranslateString(320, 'Stake LP tokens to earn Bengals')}
        </Heading>
        <Heading size="lg" color="text">
          {TranslateString(10000, 'Deposit Fee will be used to buyback Bengals and lock liquidity')}
        </Heading>
      </Header>
      <Page>
        <ControlContainer>
