...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, account }) => {
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'Bengals'
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'Bengals' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
      ...
      <ExpandingWrapper expanded={showExpandableSection}>
        <DetailsSection
          ...
          addLiquidityUrl={farm.isTokenOnly ?
            `https://exchange.Funny.app/#/swap?outputCurrency=${tokenAddresses[process.env.REACT_APP_CHAIN_ID]}`
            :
          `https://exchange.Funny.app/#/add/${liquidityUrlPathParts}`
        }
